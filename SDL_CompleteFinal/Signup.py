...
class Ui_SignupWindow(object):
    ...
    def setupUi(self, SignupWindow, flag, lw):
        ...
        SignupWindow.setStyleSheet(_fromUtf8("background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0.981818, y2:0.955, stop:0 rgba(59, 89, 152, 255), stop:1 rgba(95, 130, 206, 255));"))
